 ...
 */
public class SquareRootDecompo {
    private final int a[];
    private final long blockSums[];
    private final int sqrt;

    public SquareRootDecompo(int input[]) {
...
class Main {
    public static void main(String[] args) {
        final SquareRootDecompo sqrtDecomposition = new SquareRootDecompo(new int[]{1, 2, 6, 7, 9, 3, 1, 9});
